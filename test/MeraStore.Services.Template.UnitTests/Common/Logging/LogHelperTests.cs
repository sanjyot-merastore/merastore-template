using MeraStore.Services.Template.Common.Logging;
using MeraStore.Shared.Kernel.Context;
using MeraStore.Shared.Kernel.Logging.Loggers;

using AppContext = MeraStore.Services.Template.Common.AppContext;

namespace MeraStore.Services.Template.UnitTests.Common.Logging;
